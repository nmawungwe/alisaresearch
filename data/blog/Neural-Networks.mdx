---
title: 'Understanding Backpropagation: My Journey with the Chain Rule'
date: '2024-06-22'
tags: ['Neural Networks', 'Backpropagation', 'Python', 'Machine Learning']
draft: false
summary: 'Exploration of backpropagation and the chain rule in neural networks.'
---
...
Check it out here: [My Neural Network Project](https://github.com/nmawungwe/micrograd/blob/main/micrograd.ipynb)

Feel free to run the code and play around with it. It really helps to see it in action!
